...
public class Circle implements Shape {
	...
	public void setRadius(int radius) {
		...
		this.radius = radius;
			...
			throw new IllegalArgumentException("Valoarea razei trebuie să fie pozitivă");
	}
	...
	public void setBorderWidth(int borderWidth)
	{
		if(borderWidth>0)
			this.borderWidth = borderWidth;
				...
				throw new IllegalArgumentException("Valoarea grosimii marginii trebuie să fie pozitivă");
	}
